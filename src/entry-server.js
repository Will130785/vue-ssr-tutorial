  ...
  return new Promise((resolve, reject) => {
    ...
    router.onReady(() => {
      ...
      context.rendered = () => {
        ...
        // When we attach the state to the context, and the 'template' option is used for the renderer, the state will automatically be serialized and injected into the HTML as 'window.__INITIAL_STATE__
